...
}, _defineProperty(_apiDiff, "showActionSheet", {
  options: {
    change: [{
      old: 'title',
      new: 'content'
...
}), _defineProperty(_apiDiff, "setNavigationBarTitle", {
  alias: 'setNavigationBar'
}), _defineProperty(_apiDiff, "setNavigationBarColor", {
  alias: 'setNavigationBar'
}), _defineProperty(_apiDiff, "saveImageToPhotosAlbum", {
  alias: 'saveImage',
  options: {
    change: [{
      old: 'filePath',
...
}), _defineProperty(_apiDiff, "previewImage", {
  options: {
    set: [{
      key: 'current',
...
}), _defineProperty(_apiDiff, "getFileInfo", {
  options: {
    change: [{
      old: 'filePath',
      new: 'apFilePath'
...
}), _defineProperty(_apiDiff, "getSavedFileInfo", {
  options: {
    change: [{
      old: 'filePath',
      new: 'apFilePath'
...
}), _defineProperty(_apiDiff, "removeSavedFile", {
  options: {
    change: [{
      old: 'filePath',
      new: 'apFilePath'
...
}), _defineProperty(_apiDiff, "saveFile", {
  options: {
    change: [{
      old: 'tempFilePath',
      new: 'apFilePath'
...
}), _defineProperty(_apiDiff, "openLocation", {
  options: {
    set: [{
      key: 'latitude',
      value: function value(options) {
...
}), _defineProperty(_apiDiff, "uploadFile", {
  options: {
    change: [{
      old: 'name',
      new: 'fileName'
...
}), _defineProperty(_apiDiff, "getClipboardData", {
  alias: 'getClipboard'
}), _defineProperty(_apiDiff, "setClipboardData", {
  alias: 'setClipboard',
  options: {
    change: [{
      old: 'data',
...
}), _defineProperty(_apiDiff, "scanCode", {
  alias: 'scan',
  options: {
    change: [{
      old: 'onlyFromCamera',
...
}), _defineProperty(_apiDiff, "setScreenBrightness", {
  options: {
    change: [{
      old: 'value',
      new: 'brightness'
    ...
    Object.keys(apiDiff).forEach(function (item) {
      ...
      if (api === item) {
        ...
        if (apiItem.options) {
          ...
          if (set$$1) {
            set$$1.forEach(function (setItem) {
