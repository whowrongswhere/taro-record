...
var AtButton = function (_AtComponent) {
  ...
  function AtButton() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = AtButton.__proto__ || Object.getPrototypeOf(AtButton)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["anonymousState__temp", "anonymousState__temp2", "loading", "loadingColor", "loadingSize", "isWEAPP", "disabled", "formType", "openType", "lang", "sessionFrom", "sendMessageTitle", "sendMessagePath", "sendMessageImg", "showMessageCard", "appParameter", "onClick", "__fn_onClick", "onGetUserInfo", "__fn_onGetUserInfo", "onContact", "__fn_onContact", "onGetPhoneNumber", "__fn_onGetPhoneNumber", "onError", "__fn_onError", "onOpenSetting", "__fn_onOpenSetting", "size", "type", "circle", "full", "customStyle", "className", "children"], _this.$$refs = [], _temp), _possibleConstructorReturn(_this, _ret);
  }
